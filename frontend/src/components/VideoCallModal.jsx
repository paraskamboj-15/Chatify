...
//     const { call, callAccepted, myVideo, userVideo, stream, callEnded, leaveCall, answerCall, isCalling } = useCallContext();
//     const { callType } = useCallContext(); // Get type
...
//             <div className="bg-gray-800 rounded-2xl shadow-2xl p-4 w-full max-w-4xl flex flex-col items-center">

//                 {/* Status Header */}
//                 <h2 className="text-2xl text-white font-bold mb-4">
//                     {callAccepted ? "Call in Progress" : isCalling ? "Calling..." : `${call.name} is calling...`}
//                 </h2>

//                 <div className="flex flex-col md:flex-row gap-4 w-full justify-center items-center h-[60vh]">

//                     {/* My Video (Small if call accepted, Large if waiting) */}
//                     {stream && (
